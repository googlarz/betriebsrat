...
but do not stop the import.`,
  ...
  betriebsrat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  betriebsrat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | betriebsrat-pp-cli import <resource> --input -`,
