...
func newTopicsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/br/themen/{topic}/uebersicht"
			path = replacePathParam(path, "topic", fmt.Sprintf("%v", flagTopic))
	...
	cmd.Flags().StringVar(&flagTopic, "topic", "", "Topic slug (e.g. arbeitsrecht, kuendigung, betriebsvereinbarungen, datenschutz, ki)")
